...
object ModalViewBuilder {
    fun buildInitialTypeSelectionModal(types: List<Map<String, Any>>): View = view { v ->
        ...
        blocksList.add(
                input { i ->
                    i.blockId("channels_block")
                            ...
                            .element(
                                    checkboxes { c ->
                                        c.actionId("channels_checkboxes")
                                                .options(
                                                        listOf(
                                                                option(
                                                                        plainText("Slack DM"),
